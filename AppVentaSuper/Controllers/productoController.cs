...
namespace AppVentaSuper.Controllers
{
    public class productoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idproducto,idcategoria,codigo,nombre,precio_venta,stock,descripcion,estado")] producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idproducto,idcategoria,codigo,nombre,precio_venta,stock,descripcion,estado")] producto producto)
        {
            if (ModelState.IsValid)
            {
